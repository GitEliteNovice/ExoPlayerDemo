package request.elgroupinternational.com.exoplayerdemo.SimpleExoplayer;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void openFullscreenDialog() {
        ...
        mFullScreenIcon.setImageDrawable(ContextCompat.getDrawable(MainActivity.this, R.drawable.exo_controls_next));
    ...
    protected void onResume() {
        ...
        if (mExoPlayerView == null) {
         ...
         //   Uri daUri = Uri.parse(streamUrl);
            ...
            mVideoSource = new ExtractorMediaSource(Uri.parse("rtmp://34.212.103.14/myapp?token=vtbqxx-uk6AkyhUuisEn/4"),
