...
public class RippleBackground extends RelativeLayout
{
    ...
    private static final int DEFAULT_RIPPLE_COUNT=500;
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        paint.setPathEffect(new DashPathEffect(new float[] {3,3,3,3}, 0));
        rippleParams=new LayoutParams((int)(1.5*(rippleRadius+rippleStrokeWidth)),(int)(1.5*(rippleRadius+rippleStrokeWidth)));
